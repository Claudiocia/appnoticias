 ...
 */
public class SplashWebtv extends AppCompatActivity {

    String RSSFEEDURL = "http://www.webtv.uneb.br/";
    RSSFeed feed;
    String fileName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(conMgr.getActiveNetworkInfo()== null){
            ...
            if (!feedFile.exists()){
                ...
                Toast toast = Toast.makeText(this, "Sem conectividade. Carregando os ultimos vídeos salvas", Toast.LENGTH_LONG);
                toast.show();
    ...
    private void startLisActivity(RSSFeed feed) {
        ...
        Intent intent = new Intent(SplashWebtv.this, WebtvListActivity.class);
    ...
    private class AsyncLoadXMLFeed extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            //Obtem o feed
            DOMParseWebtv myParser = new DOMParseWebtv();
            feed = myParser.parseWebtv(RSSFEEDURL);
